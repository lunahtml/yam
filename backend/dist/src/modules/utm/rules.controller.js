...
import { CreateRuleSchema, UpdateRuleSchema, } from './contracts/rule.dto.js';
...
__decorate([
    ...
    __param(2, Body(new ZodValidationPipe(CreateRuleSchema))),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RulesController.prototype, "findByProject", null);
__decorate([
    Put(':id'),
    __param(0, CurrentUserId()),
    __param(1, Param('id')),
    __param(2, Body(new ZodValidationPipe(UpdateRuleSchema))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", Promise)
