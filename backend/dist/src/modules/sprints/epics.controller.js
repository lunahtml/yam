...
import { CreateEpicSchema, UpdateEpicSchema, } from './contracts/create-epic.dto.js';
...
__decorate([
    ...
    __param(2, Body(new ZodValidationPipe(CreateEpicSchema))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", Promise)
], EpicsController.prototype, "create", null);
__decorate([
...
__decorate([
    ...
    __param(0, CurrentUserId()),
    __param(1, Param('id')),
    __param(2, Body(new ZodValidationPipe(UpdateEpicSchema))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", Promise)
], EpicsController.prototype, "update", null);
__decorate([
    Delete(':id'),
    __param(0, CurrentUserId()),
    __param(1, Param('id')),
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], EpicsController.prototype, "remove", null);
EpicsController = __decorate([
    Controller('epics'),
    __metadata("design:paramtypes", [EpicsService])
], EpicsController);
export { EpicsController };
