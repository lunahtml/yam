...
import { CreateMetricSchema, UpdateMetricSchema, } from './contracts/create-metric.dto.js';
...
__decorate([
    ...
    __param(2, Body(new ZodValidationPipe(CreateMetricSchema))),
...
__decorate([
    ...
    __param(0, CurrentUserId()),
    __param(1, Param('id')),
    __param(2, Body(new ZodValidationPipe(UpdateMetricSchema))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Object]),
    __metadata("design:returntype", Promise)
